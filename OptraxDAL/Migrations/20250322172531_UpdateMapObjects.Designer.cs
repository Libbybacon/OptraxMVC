...
namespace OptraxDAL.Migrations
{
    ...
    [Migration("20250322172531_UpdateMapObjects")]
    partial class UpdateMapObjects
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OptraxDAL.Models.Map.MapCircle", b =>
                {
                    ...
                    b.Property<Polygon>("Area")
                        ...
                        .HasComputedColumnSql("geography::Point([Latitude], [Longitude], 4326).STBuffer([Radius])", true);
            ...
            modelBuilder.Entity("OptraxDAL.Models.Map.MapCircle", b =>
                {
                    b.HasOne("OptraxDAL.Models.Map.MapObject", null)
                        .WithOne()
                        .HasForeignKey("OptraxDAL.Models.Map.MapCircle", "ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
