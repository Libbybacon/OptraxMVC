...
var popupHandler = {
  ...
  loadPopup: function () {
    var _loadPopup = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(props) {
      var response, view;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _api_js__WEBPACK_IMPORTED_MODULE_0__["default"].get(props.url, props.data);
          case 3:
            response = _context.sent;
          ...
          case 16:
            ...
            console.error("Error loading popup:", _context.t0.message);
          case 19:
          case "end":
            return _context.stop();
        }
  ...
  setPopupHeight: function setPopupHeight() {
    ...
    var maxPopHeight = winHeight * 0.8;
    popup.css('max-height', "".concat(maxPopHeight, "px"));
  },
...
/*!****************************!*\
  ...
  \****************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _utilities_popup_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utilities/popup.js */ "./wwwroot/js/utilities/popup.js");
...
$(document).ready(function () {
  ...
  window.loadPopup = _utilities_popup_js__WEBPACK_IMPORTED_MODULE_0__["default"].loadPopup;
  window.closePopup = _utilities_popup_js__WEBPACK_IMPORTED_MODULE_0__["default"].closePopup;
});
function showMessage(props) {
  var $div = $('<div>').text(props.msg).addClass('msg').addClass(props.css);
...
function collapseNav() {
  var saveToSession = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;
