...
/* harmony import */ var leaflet_editable__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! leaflet-editable */ "./node_modules/leaflet-editable/src/Leaflet.Editable.js");
/* harmony import */ var leaflet_editable__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(leaflet_editable__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var leaflet_path_drag__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! leaflet.path.drag */ "./node_modules/leaflet.path.drag/src/Path.Drag.js");
/* harmony import */ var leaflet_path_drag__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(leaflet_path_drag__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var choices_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! choices.js */ "./node_modules/choices.js/public/assets/scripts/choices.mjs");
/* harmony import */ var imask__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! imask */ "./node_modules/imask/esm/index.js");
/* harmony import */ var driver_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! driver.js */ "./node_modules/driver.js/dist/driver.js.mjs");
/* harmony import */ var _utilities_popup_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./utilities/popup.js */ "./wwwroot/js/utilities/popup.js");
// jQuery + Bootstrap
...
window.choices = choices_js__WEBPACK_IMPORTED_MODULE_6__["default"];
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(function () {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#hide-nav').off('click').on('click', function () {
    collapseNav();
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#show-nav').off('click').on('click', function () {
    expandNav();
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).on('resize', function () {
    var $nav = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.side-nav');
    var viewW = jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).width();
  ...
  window.loadPopup = _utilities_popup_js__WEBPACK_IMPORTED_MODULE_9__["default"].loadPopup;
  window.closePopup = _utilities_popup_js__WEBPACK_IMPORTED_MODULE_9__["default"].closePopup;
  setTooltipListener();
});
...
function showMessage(props) {
  var $div = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<div>').text(props.msg).addClass('msg').addClass(props.css);
...
function collapseNav() {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.logo').removeClass('d-lg-block');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.nav-bi').removeClass('me-lg-3');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.logo-sm').removeClass('d-lg-none');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.side-nav').css('width', '50px');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.nav-text').removeClass('d-lg-block');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.logout-txt').addClass('f-xs');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.side-nav').addClass('collapsed').removeClass('expanded');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.nav-hide-tab i').toggleClass('d-none');
  if (saveToSession) {
...
function expandNav() {
  var saveToSession = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.logo').addClass('d-lg-block');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.nav-bi').addClass('me-lg-3');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.logo-sm').addClass('d-lg-none');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.side-nav').css('width', 'auto');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.nav-text').addClass('d-lg-block');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.logout-txt').removeClass('f-xs');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.side-nav').removeClass('collapsed').addClass('expanded');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.nav-hide-tab i').toggleClass('d-none');
  if (saveToSession) {
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["shared"], () => (__webpack_require__("./wwwroot/js/site.js")))
